...
//_airframe1 = [getMarkerPos "marker32", bearing, "vehicle classname", _crew1] call BIS_fnc_spawnVehicle;
_team1 = [];


if (isServer) then {
_team1 = [getmarkerpos "marker_30", east, ["rhs_t72bb_tv"],[],[],[],[],[],0] call BIS_fnc_spawnGroup;
