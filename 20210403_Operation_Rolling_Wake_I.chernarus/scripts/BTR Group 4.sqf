...
if (isServer) then {
_team1 = [getmarkerpos "marker_33", east, ["rhs_btr70_vdv"],[],[],[],[],[],0] call BIS_fnc_spawnGroup;

_wp1 = _team1 addWaypoint [getmarkerpos "wp1_2", 0];
...
//_wp1 = _crew1 addWaypoint [getmarkerpos "wp1_2", 0];
...
//_wp1a = _mygroup addWaypoint [getmarkerpos "wp1_2", 0];
